...
from app.models import Application  # Matches the class name above
...
def get_dashboard_stats(db: Session = Depends(get_db)):
    ...
    #count based on the 'status' column added to the Application model
    ...
    #simple Math to calculate the rates, with checks to avoid division by zero
