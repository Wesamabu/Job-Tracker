...
from app.routers import health, applications, dashboard, resumes, jobs, auth, insights, insights_service
...
app.include_router(insights_service.router, prefix="/api")